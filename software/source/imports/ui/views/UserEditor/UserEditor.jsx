...
import UserEditorExportImport from '../../components/UserEditorExportImport/UserEditorExportImport';
...
class UserEditor extends Component {
  ...
  constructor(props) {
    ...
    if(userDict  && (userDict.size>0 || userDict.length >0))
    {
  ...
  deleteUser = async (user) => {
    let userDelete = await this.userHandler.DeleteUser(user,user,this.state.userDict);
    this.setState({
    ...
    return (
        <div className="container-fluid seamless" style={{overflow: 'hidden' }} >
            ...
            <div className="form-group row">
              ...
              <div className="col-md-6">
                <UserEditorExportImport  reloadUsersCallback =  {()  => this.reloadUsers()}/>
              </div>
            </div>
        </div>
    )
