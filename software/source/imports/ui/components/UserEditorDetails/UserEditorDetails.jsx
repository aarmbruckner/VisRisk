...
class SurveyEditorDetails extends Component {
  ...
  constructor(props) {
    ...
    if(props.selectedUser)
    {
      ...
      if(props.selectedUser.emails && props.selectedUser.emails.length>0)
      {
  ...
  componentWillReceiveProps(nextProps){
    ...
    if(nextProps.selectedUser)
    {
      ...
      if(nextProps.selectedUser.emails && nextProps.selectedUser.emails.length>0)
      {
  ...
  updateUserEmail = (changeEvent)  => {
    ...
    {
      selectedUser.emails = [];
      selectedUser.emails.push({address:changeEvent.target.value,verified:false});
    }
 
    selectedUser.email = changeEvent.target.value;
  ...
  updateUserPassword= (changeEvent)  => {
    ...
    //this.props.setSelectedUserCallback(selectedUser); 
    $("#userPassword-input").val(changeEvent.target.value);
  }
