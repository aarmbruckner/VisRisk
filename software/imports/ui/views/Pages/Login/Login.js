              ...
              <div className="card-group mb-0">
                <div className="card p-4">
                  <div className="card-block">
                    ...
                    <p className="text-muted">{i18n.getTranslation("common.loginPage.signIn")}</p>
                    ...
                    <div className="row">
                      ...
                      <div className="col-6 text-right">
                        <button style={{display:"none" }} type="button" className="btn btn-link px-0">Forgot password?</button>
                      </div>
                    </div>
                  </div>
                </div>
