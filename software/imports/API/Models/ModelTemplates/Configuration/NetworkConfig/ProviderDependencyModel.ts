export default class ProviderDependencyModel  {
    ...
    constructor(id : number, timeLimitLow : number,   timelimitMedium : number,   timeUnitLow : string,   timeUnitMedium : string,   probabilityLow : number,   probabilityMedium : number,   probabilityHigh : number)
    {
        this.id = id;
