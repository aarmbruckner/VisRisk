...
export default class SurveyNodeModel  implements IJSONParseableModel{
     ...
     constructor(_id : number,   name : string,  description : string,  failureProbability : number,numberOfVotes:number)
     {
         this._id = _id;
         this.name = name;
     ...
     public LoadFromJSONModel(jsonModelS : any)
     {
        ...
        this.numberOfVotes = jsonModelS.numberOfVotes;
     ...
     public GetJSONModel()
     {
        ...
        {
            jsonObject.estimationRectangle = this.estimationRectangle.GetJSONModel();
        }
         
 
        if(this.logInfoModel)
        {
            jsonObject.logInfoModel = this.logInfoModel.GetJSONModel();
        }

        if(this.gridInfoModel)
        {
            jsonObject.gridInfoModel = this.gridInfoModel.GetJSONModel();
        }

        if(this.calcConfigModel)
        {
            jsonObject.calcConfigModel = this.calcConfigModel.GetJSONModel();
        }

        if(this.gridConfigModel)
        {
            jsonObject.gridConfigModel = this.gridConfigModel.GetJSONModel();
        }
        return jsonObject;
     }
    ...
    public SetNumberOfVotes(numberOfVotes : number){
        this.numberOfVotes = numberOfVotes;
    }
